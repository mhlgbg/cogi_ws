...
module.exports = {
  ...
  features: [
    ...
    {
      name: 'Question Stimulus Management',
      key: 'learning.question-stimulus.manage',
      order: 5,
      description: 'Manage tenant reusable question stimuli and source materials',
      path: '/learning/questions',
      icon: 'cilLibrary',
      showInMenu: false,
    },
    ...
    },
    {
      ...
      order: 8,
      description: 'Manage tenant assessments, versions, sections, and assessment question configuration',
      path: '/learning/questions',
      icon: 'cilLibrary',
      showInMenu: false,
    },
