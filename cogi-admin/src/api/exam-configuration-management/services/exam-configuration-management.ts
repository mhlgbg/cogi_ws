...
export async function listExamConfigurationComponents(query: Record<string, unknown> = {}, tenantId: number | string) {
...
export async function getExamConfigurationComponentDetail(idParam: unknown, tenantId: number | string) {
