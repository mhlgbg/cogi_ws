...
export function getExamEligibilityApiMessage(error, fallback) {
  ...
  const mapped = {
    ...
    EXAM_ELIGIBILITY_RESTRICTED_MODE_REQUIRED: 'Đợt thi không sử dụng chế độ đăng ký có điều kiện.',
    EXAM_ELIGIBILITY_PENDING_APPROVAL_LOCKED: 'Đợt thi đang chờ phê duyệt.',
    EXAM_ELIGIBILITY_REGISTRATION_CLOSED: 'Đợt thi đã đóng đăng ký.',
    EXAM_ELIGIBILITY_WORKFLOW_LOCKED: 'Đợt thi đã qua giai đoạn cho phép thay đổi đối tượng đăng ký.',
    ...
    EXAM_ELIGIBILITY_IMPORT_FILE_REQUIRED: 'Bạn cần chọn file Excel để import.',
    EXAM_ELIGIBILITY_IMPORT_INVALID_FILE_TYPE: 'Chỉ hỗ trợ file Excel .xlsx hoặc .xls.',
    EXAM_ELIGIBILITY_IMPORT_FILE_TOO_LARGE: 'File Excel vượt quá giới hạn cho phép.',
    EXAM_ELIGIBILITY_IMPORT_INVALID_SHEET: 'File import phải có sheet Eligibility.',
    EXAM_ELIGIBILITY_IMPORT_EMPTY_FILE: 'File import không có dữ liệu hợp lệ.',
    EXAM_ELIGIBILITY_IMPORT_INVALID_HEADER: 'Header file import không hợp lệ. Cần có cột learnerCode.',
    EXAM_ELIGIBILITY_IMPORT_ROW_LIMIT_EXCEEDED: 'File import vượt quá số dòng cho phép.',
    EXAM_ELIGIBILITY_IMPORT_HAS_ERRORS: 'File import còn lỗi. Vui lòng sửa file và preview lại.',
    EXAM_ELIGIBILITY_IMPORT_REGISTRATION_CONFLICT: 'Learner đã có hồ sơ đăng ký nên không thể đổi sang trạng thái không đủ điều kiện bằng import.',
    LEARNER_CODE_NOT_UNIQUE: 'Có nhiều learner trùng learnerCode trong tenant hiện tại.',
    LEARNER_CODE_REQUIRED: 'learnerCode là bắt buộc.',
