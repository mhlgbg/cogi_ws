                ...
                <CCard className='ai-card'>
                  ...
                  <CCardBody>
                    <CRow className='g-3 mb-3 ai-form'>
                      <CCol md={4}>
                        <CFormLabel>Tìm dịch vụ</CFormLabel>
                        <CFormInput
                    ...
                    <CTable responsive hover className='mb-0 ai-table'>
                      <CTableHead>
                        <CTableRow>
                          ...
                          <CTableHeaderCell style={{ minWidth: 220 }}>Dịch vụ</CTableHeaderCell>
                          ...
                          <CTableHeaderCell style={{ minWidth: 220 }}>Tệp đính kèm</CTableHeaderCell>
                            ...
                            <CTableRow key={`${row.id || 'new'}-${index}`}>
                              ...
                              <CTableDataCell>
                                ...
                                {Array.isArray(row.selectedFiles) && row.selectedFiles.length > 0 ? (
                                  <div className='small text-body-secondary mt-1'>{row.selectedFiles.length} tệp mới</div>
                                ) : null}
                              </CTableDataCell>
                              <CTableDataCell>
