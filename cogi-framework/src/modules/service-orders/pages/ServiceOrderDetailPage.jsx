...
import { getServiceOrderById, updateServiceOrder } from '../services/serviceOrderListService'
import {
  formatDateTime,
  formatMoney,
  getOrderStatusMeta,
...
export default function ServiceOrderDetailPage() {
  ...
  const canUpdateOrder = hasAnyFeature(ORDER_UPDATE_KEYS)
  const canCreatePayment = hasAnyFeature(PAYMENT_CREATE_KEYS)
        ...
        <CCard className='mb-4 ai-card'>
          <CCardHeader className='d-flex justify-content-between align-items-center flex-wrap gap-2'>
            ...
            <div className='d-flex gap-2'>
              ...
              {canUpdateOrder && isEditableOrder ? (
          ...
          <CCardBody>
            ...
            {loading ? (
              ...
              <>
                    ...
                    <CCard className='border-0 bg-light h-100'>
                      ...
                      <CCardBody>
                        <CRow className='g-2 small'>
                          ...
                          <CCol md={6}><strong>Bộ phận:</strong> {order.department?.name || '-'}</CCol>
                ...
                <CCard className='mb-4 ai-card'>
                  <CCardHeader><strong>Danh sách item</strong></CCardHeader>
                  <CCardBody>
                    <CTable hover responsive className='mb-0 ai-table'>
                      <CTableHead>
                        <CTableRow>
                          ...
                          <CTableHeaderCell>Tệp đính kèm</CTableHeaderCell>
