const admissionManagementFeatures = {
  group: {
    name: 'Admission',
    code: 'admission',
    order: 16,
  ...
  features: [
    ...
    },
    {
      ...
      order: 3,
      description: 'Manage tenant notification templates for invite, OTP, and result messages',
...
export default admissionManagementFeatures